...
JLD2.@save "pSGLD_noise_0.05_pstorev3" p_store
#JLD2.@save "pSGLD_noise_0.05_val_lossv2" list_loss_val 
#JLD2.@save "pSGLD_noise_0.05_train_lossv2" list_loss_train

#JLD2.@save "C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_05/WJ_Integrate_Chem_Data_SGLD_60000_noise_0.05.jld2" p_store

#JLD2.@load "C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_05/WJ_Integrate_Chem_Data_SGLD_60000_noise_0.05.jld2" p_store



#p_store=load("pSGLD_noise_0.05_pstorev3")["p_store"]
...
####################################REACTION 3##############################
Reaction1 = (1/nsample)* [w_in_react[1, 1], w_in_react[1, 2], w_in_react[1, 3], w_in_react[1, 4], w_in_react[1, 5]]
labels = ["Species A", "Species B", "Species C", "Species D", "Species E"]

bar(labels, Reaction1, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:purple, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box,  ylabel = "Recovery Probability", title = "Reaction 2", legend= false)
...
bar(labels, Score1, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:purple, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Score = Probability * Coeff Count", legend=false, title = "Reaction 2", dpi=300)
...
bar(labels, Reaction4, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:red, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box,  ylabel = "Recovery Probability", legend=false,title = "Reaction 4")
...
density(k2,linewidth = 3, top_margin = 5mm, right_margin = 5mm, ylims = (0, 250), ylabel="Density", label = "Recovered rate", color =:red,framestyle = :box, grid =:off, legend = :topright, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, dpi=300 )
...
bar(labels, Score4, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:red, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Score = Probability * Coeff Count", legend=false, title = "Reaction 4", dpi=300)
...
density(k3,linewidth = 3, top_margin = 5mm, right_margin = 5mm, ylims = (0, 250),label = "Recovered rate", ylabel="Density", color =:blue,framestyle = :box, grid =:off, legend = :topright, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, dpi=300 )
...
bar(labels, Score2, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:blue, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box,  ylabel = "Score = Probability * Coeff Count", title = "Reaction 3", legend= false, dpi=300)

score_c= plot!(f, xlims = (0,5), color = :black, linewidth = 3, label = "Score = 1", linestyle =:dash, dpi=300)

#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_05/Score_Noise_0.05_Reaction2_60000.pdf")

####################################REACTION 3##############################
Reaction3 = (1/nsample)* [w_in_react[4, 1], w_in_react[4, 2], w_in_react[4, 3], w_in_react[4, 4], w_in_react[4, 5]]
labels = ["Species A", "Species B", "Species C", "Species D", "Species E"]
...
density(k4,linewidth = 3, top_margin = 5mm, right_margin = 5mm, ylims = (0, 250), label = "Recovered rate", ylabel="Density", color =:green,framestyle = :box, grid =:off, legend = :topright, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, dpi=300 )

p2_a = plot!([abs(true_rate)-0.000001,abs(true_rate)+0.0000001],[0.0, 150],lw=3,color=:black,label = string("True reaction rate"),linestyle = :dash)
...
bar(labels, Score3, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:green, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Score = Probability * Coeff Count", title="Reaction 1", legend= false)
...
plot(p3_a, p3_b, p3_c, p3_d, layout= score_layout, size=(1200, 900), margin= 20mm,  dpi=300)
