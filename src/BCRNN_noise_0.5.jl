...
a = 0.001;#0.0001; #try making this larger
b = 0.15;
γ = 0.005;
...
for epoch in epochs
    ...
    exp_minibatch= random_list_exp[1:20]
    for i_exp in exp_minibatch #change this to be like a mini batch?
...
JLD2.@save "pSGLD_noise0.5_pstorev1" p_store
#JLD2.@save "C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/WJ_Integrate_Chem_Data_SGLD_60000_noise_0.5.jld2" p_store

#JLD2.@load "C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/WJ_Integrate_Chem_Data_SGLD_60000_noise_0.5.jld2" p_store


p_store=load("pSGLD_noise0.5_pstorev1")["p_store"]
...
bar(labels, Reaction3, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:blue, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Recovery Probability", legend=false, title = "Reaction 3", dpi=300)

f(x) = 1
p1_c = plot!(f, xlims = (0,5), color = :black, linewidth = 3, label = "", linestyle =:dash, dpi=300)
...
density(k1, linewidth = 3, top_margin = 5mm, right_margin = 5mm, ylims = (0, 100), label = "Recovered rate", ylabel="Density", color =:blue,framestyle = :box, grid =:off, legend = :topright, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, dpi=300 )

p2_c = plot!([abs(true_rate)-0.000001,abs(true_rate)+0.0000001],[0.0,50],lw=3,color=:black,label = string("True reaction rate"),linestyle = :dash, dpi=300)

l = @layout [a; b]

p3_c= plot(p1_c, p2_c,layout = l, dpi=300)

#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/Noise_0.5_Reaction3_60000.pdf")

Score3 = w_in_coeff[1,:] .*  Reaction3

bar(labels, Score3, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:blue, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Score = Probability * Coeff Count", legend=false, title = "Reaction 3", dpi=300)

score_c= plot!(f, xlims = (0,5), color = :black, linewidth = 3, label = "Score = 1", linestyle =:dash, dpi=300)

#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/Score_Noise_0.5_Reaction3_60000.pdf")
...
bar(labels, Reaction4, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:purple, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Recovery Probability", legend= false, title = "Reaction 2", dpi=300)

f(x) = 1
p1_b = plot!(f, xlims = (0,5), color = :black, linewidth = 3, label = "", linestyle =:dash, dpi=300)
...
density(k2,linewidth = 3, top_margin = 5mm, right_margin = 5mm, ylims = (0, 100), label = "Recovered rate", ylabel="Density", color =:purple,framestyle = :box, grid =:off, legend = :topright, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, dpi=300 )

p2_b = plot!([abs(true_rate)-0.000001,abs(true_rate)+0.0000001],[0.0, 50],lw=3,color=:black,label = string("True reaction rate"),linestyle = :dash, dpi=300)

l = @layout [a; b]

p3_b= plot(p1_b, p2_b, layout = l, dpi=300)

#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/Noise_0.5_Reaction4_60000.pdf")
...
#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/Score_Noise_0.5_Reaction4_60000.pdf")

####################################REACTION 1##############################
Reaction1 = (1/nsample)* [w_in_react[3, 1], w_in_react[3, 2], w_in_react[3, 3], w_in_react[3, 4], w_in_react[3, 5]]
labels = ["Species A", "Species B", "Species C", "Species D", "Species E"]

bar(labels, Reaction1, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:red, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Recovery Probability", legend=false, title = "Reaction 4", dpi=300)

f(x) = 1
p1_d = plot!(f, xlims = (0,5), color = :black, linewidth = 3, label = "", linestyle =:dash, dpi=300)
...
density(k3, linewidth = 3, top_margin = 5mm, right_margin = 5mm, ylims = (0, 100), label = "Recovered rate", ylabel="Density", color =:red,framestyle = :box, grid =:off, legend = :topright, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, dpi=300 )

p2_d = plot!([abs(true_rate)-0.000001,abs(true_rate)+0.0000001],[0.0, 50],lw=3,color=:black,label = string("True reaction rate"),linestyle = :dash, dpi=300)

l = @layout [a; b]

p3_d= plot(p1_d, p2_d, layout = l, dpi=300)

#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/Noise_0.5_Reaction1_60000.pdf")

Score1 = w_in_coeff[3,:] .*  Reaction1
...
#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/Score_Noise_0.5_Reaction1_60000.pdf")

####################################REACTION 2##############################
Reaction2 = (1/nsample)* [w_in_react[4, 1], w_in_react[4, 2], w_in_react[4, 3], w_in_react[4, 4], w_in_react[4, 5]]
labels = ["Species A", "Species B", "Species C", "Species D", "Species E"]

bar(labels, Reaction1, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:green, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Recovery Probability", legend=false, title = "Reaction 1", dpi=300)

f(x) = 1
p1_a = plot!(f, xlims = (0,5), color = :black, linewidth = 3, label = "", linestyle =:dash, dpi=300)
...
density(k4,linewidth = 3, top_margin = 5mm, right_margin = 5mm, ylims = (0, 100), label = "Recovered rate", ylabel="Density", color =:green,framestyle = :box, grid =:off, legend = :topright, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, dpi=300 )

p2_a = plot!([abs(true_rate)-0.000001,abs(true_rate)+0.0000001],[0.0, 50],lw=3,color=:black,label = string("True reaction rate"),linestyle = :dash, dpi=300)

l = @layout [a; b]

p3_a= plot(p1_a, p2_a, layout = l, dpi=300)

#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/Noise_0.5_Reaction2_60000.pdf")

Score2 = w_in_coeff[4,:] .*  Reaction2

bar(labels, Score2, left_margin = 5mm, top_margin = 5mm, right_margin = 5mm, color =:green, alpha = 0.5,  ylims = (0, 1.5),  framestyle = :box, ylabel = "Score = Probability * Coeff Count", legend=false, title = "Reaction 1", dpi=300)

score_a= plot!(f, xlims = (0,5), color = :black, linewidth = 3, label = "Score = 1", linestyle =:dash, dpi=300)

#savefig("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/Jul21Analysis/Noise0_5/Score_Noise_0.5_Reaction2_60000.pdf")
...
markercolor=:transparent,
label="Exp",
framestyle=:box, color =:purple, alpha = 0.5, dpi=300)
if j == 1
...
for i in 1:500
  ...
  if i == 1
    ...
    plot!(plt, tsteps, color = :purple, alpha = 1, pred[j,:], label="CRNN-ODE", dpi=300)
    plot!(xlabel="t", ylabel="Concentration of " * species[j], dpi=300)

else
    p_pred = p_store[:, end-i];
    pred = predict_neuralode(u0_list[1, :], p_pred)

    plot!(plt, tsteps, color = :purple, alpha = 0.02, pred[j,:], label="", dpi=300)
    plot!(xlabel="t", ylabel="Concentration of " * species[j], dpi=300)
end
...
#savefig(plt_all, string("C:/Users/16174/OneDrive/Desktop/Julia Lab/Bayesian Neural UDE/PDE/ChemicalReaction/figs/Case1_AllPlot_Noise0.5.pdf") )
